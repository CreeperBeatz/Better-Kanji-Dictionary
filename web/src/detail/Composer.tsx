...
const S = strings(
  {
    ...
    kanjifyTitle: 'Mark the kanji and parts your story mentions: a person [亻] leans on a tree [木] to rest [休]. Leave [] after a word to have its kanji put in.',
  ...
  },
  {
    ...
    kanjifyTitle: 'Отбелязва кандзито и частите, които историята ви споменава: човек [亻] се облегнал на дърво [木], за да си почине [休]. Оставете [] след дума, за да се попълни кандзито ѝ.',
